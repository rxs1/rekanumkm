            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-building-o" aria-hidden="true"></i> <a href="##">Tambah UMKM</a>
                            </li>
                ...
                <div class="row">
                   <div class="col-md-6 col-md-offset-3">
                        <form role="form" method="POST" enctype="multipart/form-data" action="<?=base_url()?>user/common_user/umkm/add_process">
                                  <?php
                ...
                ?>
                            ...
                            <div class="form-group">
                                ...
                                <input  name="name" required type='text' class="form-control" placeholder="ex: PT. UMKM Sukses">
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
                            ...
                            <center>
                              <button type="submit" class="btn btn-primary btn-lg" >Tambah UMKM </button>
                            </center>
