 <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                            <i class="fa fa-calculator "></i> <a href="<?=base_url()?>user/common_user/labarugi/kalkulasi/<?=$store['store_id']?>">Laba Rugi Pilih Bulan</a>
                            </li>
                ...
                <div class="row" style="margin: 100px">
                       ...
                       <form method="post" action="<?=base_url()?>user/common_user/labarugi/kalkulasi_proses/<?=$store['store_id']?>">
