 <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row" style="margin-left: 100px;margin-right: 100px">
                    ...
                    <table class="table">
                          <?php
                            if($bukubesarekuitas['modal_pemilik']){
                              echo "<tr>
                                <th>No</th>
                                <th>Jurnal</th>
                              ...
                              ";
                              $i=1;
                              foreach ($bukubesarekuitas['modal_pemilik'] as $list) {
                              ...
                              echo "<tr style='background:#ccc'>
                                ...
                                <td>
                                <p style='font-size:30px'>".$bukubesarekuitas['modal_pemilik_total']."</p>
                                </td>
                              </tr>
                              ";
                            }else{
                ...
                <div class="row" style="margin-left: 100px;margin-right: 100px">
                    ...
                    <table class="table">
                          <?php
                            if($bukubesarekuitas['penarikan_modal']){
                              echo "<tr>
                                <th>No</th>
                                <th>Jurnal</th>
                                <th>Tipe Transaksi</th>
                              ...
                              ";
                              $i=1;
                              foreach ($bukubesarekuitas['penarikan_modal'] as $list) {
                              ...
                              echo "<tr style='background:#ccc'>
                                ...
                                <td>
                                <p style='font-size:30px'>".$bukubesarekuitas['penarikan_modal_total']."</p>
                                </td>
                              </tr>
                              ";
                            }else{
