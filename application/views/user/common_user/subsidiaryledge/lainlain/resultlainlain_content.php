 <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                          ...
                          <li>
                            ...
                            <li>
                            <i class="fa fa-calculator "></i> <a href="<?=base_url()?>user/common_user/bukubesar/lainlain/<?=$store['store_id']?>">Lain-Lain</a>
                            </li>
                 ...
                 <?php
                      if($this->session->userdata('data') == null){
                        ...
                        $bukubesarlainlain=$this->session->userdata('data');
                ...
                <div class="row" style="margin-left: 100px;margin-right: 100px">
                    ...
                    <h2>Pendapatan Bunga Bank</h2>
                    <hr>
                    <br>
                    <table class="table">
                          <?php
                            if($bukubesarlainlain['pendapatan_bungabank']){
                              echo "<tr>
                                <th>No</th>
                                <th>Jurnal</th>
                              ...
                              ";
                              $i=1;
                              foreach ($bukubesarlainlain['pendapatan_bungabank'] as $list) {
                              ...
                              echo "<tr style='background:#ccc'>
                                ...
                                <td>
                                <p style='font-size:30px'>".$bukubesarlainlain['pendapatan_bungabank_total']."</p>
                                </td>
                              </tr>
                              ";
                            }else{
                ...
                <div class="row" style="margin-left: 100px;margin-right: 100px">
                    ...
                    <h2>Beban Administrasi Bank</h2>
                    <hr>
                    <br>
                    <table class="table">
                          <?php
                            if($bukubesarlainlain['beban_administrasibank']){
                              echo "<tr>
                                <th>No</th>
                                <th>Jurnal</th>
                                <th>Tipe Transaksi</th>
                              ...
                              ";
                              $i=1;
                              foreach ($bukubesarlainlain['beban_administrasibank'] as $list) {
                              ...
                              echo "<tr style='background:#ccc'>
                                ...
                                <td>
                                <p style='font-size:30px'>".$bukubesarlainlain['beban_administrasibank_total']."</p>
                                </td>
                              </tr>
                              ";
                            }else{
