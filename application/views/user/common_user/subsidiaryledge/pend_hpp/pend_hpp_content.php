 <div id="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                          ...
                          <li>
                            ...
                            <li>
                            <i class="fa fa-calculator "></i> <a href="<?=base_url()?>user/common_user/bukubesar/pend_hpp/<?=$store['store_id']?>">Pend + HPP</a>
                            </li>
                ...
                <div class="row" style="margin: 100px">
                       ...
                       <form method="post" action="<?=base_url()?>user/common_user/bukubesar/pend_hpp_proses/<?=$store['store_id']?>">
