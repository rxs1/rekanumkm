            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                          ...
                          <li>
                             ...
                             <li>
                                <i class="fa fa-book "></i> <a href="<?=base_url()?>user/common_user/akuntansi/tambahTransaksiJurnalPenerimaanKas/<?=$store['store_id']?>">Tambah Transaksi</a>
                            </li>
                ...
                <div class="row" style="margin: 100px">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        ?>
                        <form method="POST" action="<?=base_url()?>user/common_user/akuntansi/tambahTransaksijurnalPenerimaanKas_proses/<?=$store['store_id']?>">
