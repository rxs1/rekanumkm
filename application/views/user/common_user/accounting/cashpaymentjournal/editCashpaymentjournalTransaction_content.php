            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                          ...
                          <li>
                             ...
                             <li>
                                <i class="fa fa-book "></i> <a href="<?=base_url()?>user/common_user/akuntansi/editTransaksiJurnalPembelian/<?=$store['store_id']?>/<?=$journal['journal_id']?>/<?=$journal['journaltype_id']?>">Edit Transaksi</a>
                            </li>
                ...
                <div class="row" style="margin: 100px">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        ?>
                        <form method="POST" action="<?=base_url()?>user/common_user/akuntansi/editTransaksijurnalPengeluaranKas_proses/<?=$journal['journal_id']?>">
                          ...
                          <div class="form-group">
                            <label for="pwd">Tujuan Transaksi</label>
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="paymentmethod_id"  id="sel3">
...
$('#sel1').change(function () {
    ...
    $("#sel3").html("<option>Pilih Terlebih Dahulu Tujuan Transaksi</option>");
