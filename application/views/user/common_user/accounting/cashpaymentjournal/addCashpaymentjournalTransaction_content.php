            ...
            <div class="container-fluid">
                ...
                <div class="row" style="margin: 100px">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        ?>
                        <form method="POST" action="<?=base_url()?>user/common_user/akuntansi/tambahTransaksijurnalPengeluaranKas_proses/<?=$store['store_id']?>">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="subtransactioncategory_id" disabled id="sel2">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="paymentmethod_id" disabled id="sel3">
