            ...
            <div class="container-fluid">
                ...
                <div class="row" style="margin: 100px">
                    <div class="col-md-6">
                        ...
                        <button style="margin-bottom: 20px" class="btn btn-primary btn-lg col-md-12"> Jurnal Penjualan</button>
                    ...
                    <div class="col-md-6">
                         ...
                         <button style="margin-bottom: 20px" class="btn btn-primary btn-lg col-md-12"> Jurnal Penyesuaian</button>

                    </div>

                      <div class="col-md-12">
                   
                         <button style="margin-top: 40px" class="btn btn-danger btn-lg col-md-6 col-md-offset-3"> Lihat Laporan</button>
