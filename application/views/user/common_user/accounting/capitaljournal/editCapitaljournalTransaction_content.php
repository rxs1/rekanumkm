            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                          ...
                          <li>
                              ...
                              <li>
                                <i class="fa fa-book "></i> <a href="<?=base_url()?>user/common_user/akuntansi/jurnalModal/<?=$store['store_id']?>/5">Jurnal Modal</a>
                            </li>

                             <li>
                                <i class="fa fa-book "></i> <a href="<?=base_url()?>user/common_user/akuntansi/editTransaksiJurnalModal/<?=$store['store_id']?>/<?=$journal['journal_id']?>/5">Edit Transaksi</a>
                            </li>
                ...
                <div class="row" style="margin: 100px">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        ?>
                        <form method="POST" action="<?=base_url()?>user/common_user/akuntansi/editTransaksijurnalModal_proses/<?=$journal['journal_id']?>">
