 <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row" style="margin: 100px">
                    <div class="col-md-3"> 
                         <a href="<?=base_url()?>user/common_user/akuntansi/tambahTransaksiJurnalPembelian/<?=$store['store_id']?>/1"><button style="margin-bottom: 20px" class="btn btn-danger btn-lg col-md-12">+ Tambah Transaksi</button></a>
                    </div>
                    <div class="col-md-12">
                     <?php
                    ...
                    <div class="col-md-12">
                        ...
                        <table id="example" class="table table-stripped" width="100%">
                          <thead>
                              ...
                              <?php 
                              if($purchasejournals){
                              foreach ($purchasejournals as $list){
                                  $button_tindakan=" 

                             <a href ='".base_url()."user/common_user/akuntansi/editTransaksiJurnalPembelian/".$store['store_id']."/".$list['journal_id']."/1'  class='btn btn-success' ><i class='glyphicon glyphicon-edit'></i></a> 
