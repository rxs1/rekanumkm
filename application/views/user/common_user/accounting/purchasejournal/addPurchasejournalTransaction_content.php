            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                          ...
                          <li>
                              ...
                              <li>
                                <i class="fa fa-book "></i> <a href="<?=base_url()?>user/common_user/akuntansi/jurnal_pembelian/<?=$store['store_id']?>">Jurnal Pembelian</a>
                            </li>
                ...
                <div class="row" style="margin: 100px">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        ?>
                        <form method="POST" action="<?=base_url()?>user/common_user/akuntansi/tambahTransaksiJurnalPembelian_proses/<?=$store['store_id']?>">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="paymentmethod_id" id="sel1">
                              <?php foreach ($paymentmethods as $list) {
                                ?>
                             <option value="<?=$list['paymentmethod_id']?>"><?=$list['name']?></option>
                                <?php }?>
                            </select>
                          </div>
                          <div class="form-group">
