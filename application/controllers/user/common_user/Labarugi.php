...
class Labarugi extends CI_Controller {
	...
	{	
		...
		$data['title']= 'Kalkulasi Laba Rugi Untuk : '.$data['store']['name'];
		$this->load->view('user/common_user/head',$data);
		$this->load->view('user/common_user/header',$data);
		$this->load->view('user/common_user/labarugi/labarugi_content',$data);
	   ...
	   $this->form_validation->set_rules('bulan-tahun', 'BUlan Tahun', 'required');
	 	...
	 	if($this->form_validation->run() == TRUE){
	 		$data_x=$this->input->post();
		  		...
		  		redirect(base_url().'user/common_user/labarugi/resultLabarugi/'.$store_id);
	...
	public function resultLabarugi($store_id){
		...
		$data['title']= 'Labarugi Untuk : '.$data['store']['name'] ; 
		$this->load->view('user/common_user/head',$data);
		$this->load->view('user/common_user/header',$data);
		$this->load->view('user/common_user/labarugi/resultLabarugi_content',$data);
	}
